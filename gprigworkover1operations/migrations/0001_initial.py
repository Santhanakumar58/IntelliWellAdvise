...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('gprigworkover1', '0001_initial'),
    ]

    operations = [
        migrations.CreateModel(
            name='GPRigworkoverOperation',
            fields=[
                ...
                ('gprigworkover', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='gprigworkover1.gprigworkover')),
            ],
        ),
    ]
