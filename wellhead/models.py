...
class Wellhead(models.Model):  
    ...
    wh_Type =models.CharField(max_length = 50,choices = WHTypes,default = 'Single')   
    SealingTypes = (
        ("Elastomer" , 'Elastomer'),
    ...
    seal =models.CharField(max_length = 50,choices = SealingTypes,default = 'MetaltoMetal') 
    HangerTypes = (
        ("Mandrel" , 'Mandrel'),
    ...
    hanger_Type =models.CharField(max_length = 50,choices = HangerTypes,default = 'Mandrel')     
    FlangeSizes = (
    ...
    flange_Size=models.CharField(max_length = 50,choices = FlangeSizes, default = 'E1') 
    Connections=(
        ('Threaded','Threaded'),
        ('Welded','Welded'),
        ('Flanged', 'Flanged'),
    ...
    connection = models.CharField(max_length = 50,choices = Connections, default = 'Threaded') 
    ValveeSizes = (
        ('A', "2 1/16"),
        ('B', "3 1/16"),
        ('C', "3 1/8"),
    ...
    valve_Size=models.CharField(max_length = 50,choices = ValveeSizes,default = 'A') 
    TempRatings = (
        ('K', "-75-180 F"), 
        ('L', "-50-180 F"), 
        ('N', "-50-140 F"),
    ...
    temperature_Rating=models.CharField(max_length = 50,choices = TempRatings,default = 'K')     
    Materials = (
    ...
    material=models.CharField(max_length = 50,choices = Materials,default = 'AA')     
    Services =(
        ('AA', "General Service"),
        ('BB', "General Service"), 
        ('CC', "General Service"), 
    ...
    service=models.CharField(max_length = 50,choices = Services,default = 'AA') 
    ...
    product_Service_Level=models.CharField(max_length = 50,choices = ServiceLevels,default = 'PL1') 


class Tree(models.Model):  
    wellhead = models.ForeignKey(Wellhead, on_delete=models.CASCADE)
    fgid = models.PositiveIntegerField()   
    wellid = models.PositiveIntegerField() 
    ...
    treetype =models.CharField(max_length = 50,choices = TreeTypes,default = 'Single')  
    PressureRatings = (
        ("K2" , '2000 psi'),
        ("K3" , '3000 psi'),
        ("K5" , '5000 psi'),
    ...
    pressure_rating =models.CharField(max_length = 50,choices = PressureRatings,default = 'K5')     
    ValveeSizes = (
        ('A', "2 1/16"),
        ('B', "3 1/16"),
        ('C', "3 1/8"),
    ...
    materialRating=models.CharField(max_length = 50,choices = Materials,default = 'AA')     
    Services =(
        ('AA', "General Service"),
        ('BB', "General Service"), 
        ('CC', "General Service"), 
    ...
    produvt_service_level=models.CharField(max_length = 50,choices = ServiceLevels,default = 'PL1') 
