...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('gpstimulation', '0001_initial'),
    ]

    operations = [
        migrations.CreateModel(
            name='GPStimulationOperation',
            fields=[
                ...
                ('gpstimulation', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='gpstimulation.gpstimulation')),
            ],
        ),
    ]
