...
class OBProductivityIndexModel(models.Model):
...
class OBVogelModel(models.Model):
    fgid = models.PositiveIntegerField()   
    wellid = models.PositiveIntegerField() 
    analysis_Date = models.DateField()
...
class OBStandingsModel(models.Model):
    fgid = models.PositiveIntegerField()   
    wellid = models.PositiveIntegerField() 
    analysis_Date = models.DateField()
...
class OBWigginsModel(models.Model):
    fgid = models.PositiveIntegerField()   
    wellid = models.PositiveIntegerField() 
    analysis_Date = models.DateField()
...
class OBMultirateModel(models.Model):
    fgid = models.PositiveIntegerField()   
    wellid = models.PositiveIntegerField() 
    analysis_Date = models.DateField()
...
class OBDarcyModel(models.Model):
    fgid = models.PositiveIntegerField()   
    wellid = models.PositiveIntegerField() 
    analysis_Date = models.DateField()
