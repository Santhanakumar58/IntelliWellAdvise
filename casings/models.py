...
class CasingWeightModel(models.Model):
    casingSize = models.ForeignKey(CasingSizeModel, on_delete=models.CASCADE)
    casingWeight = models.CharField(max_length=20)
    casingID = models.DecimalField(max_digits=10, decimal_places=3)
   
    def __str__(self):
        return self.casingWeight

class CasingGradeModel(models.Model):    
    casingWeight = models.ForeignKey(CasingWeightModel, on_delete=models.CASCADE)
...
class CasingModel(models.Model):      
    ...
    casingType = models.CharField(max_length = 20,choices = Casing_Types,default = 'Surface', blank=True, null=True)
    ...
    threadType=models.CharField(max_length = 20,choices = Casing_Threads,default = '1', blank=True, null=True)
    Materials =(        
            ("1", "Carbon_Steel"),
            ("2", "CRA_9Cr"),  
            ("3", "CRA_13Cr"), 
