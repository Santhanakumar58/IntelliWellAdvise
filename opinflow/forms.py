...
from .models import ProductivityIndexModel, VogelModel,WigginsModel,MultirateModel,StandingsModel,DarcyModel

class ProductivityIndexForm(forms.ModelForm):
    analysis_Date = forms.DateField(widget=forms.DateInput(attrs=dict(type='date')))
    class Meta:
        model = ProductivityIndexModel
        fields =['analysis_Date', 'productivity_index', 'reservoir_Pressure', 'layer_Name', 'pvt_Well']
    

class VogelForm(forms.ModelForm):
    analysis_Date = forms.DateField(widget=forms.DateInput(attrs=dict(type='date')))
    class Meta:
        model = VogelModel
...
class StandingsForm(forms.ModelForm):
    analysis_Date = forms.DateField(widget=forms.DateInput(attrs=dict(type='date')))
    class Meta:
...
class WigginsForm(forms.ModelForm):
    analysis_Date = forms.DateField(widget=forms.DateInput(attrs=dict(type='date')))
    class Meta:
        model = WigginsModel
...
class MultiRateForm(forms.ModelForm):
    analysis_Date = forms.DateField(widget=forms.DateInput(attrs=dict(type='date')))
    class Meta:
        model = MultirateModel
...
class DarcyModelForm(forms.ModelForm):
    analysis_Date = forms.DateField(widget=forms.DateInput(attrs=dict(type='date')))
    class Meta:
        model = DarcyModel
