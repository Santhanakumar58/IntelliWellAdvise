...
class ProductivityIndexModel(models.Model):
...
class StandingsModel(models.Model):
    fgid = models.PositiveIntegerField()   
    wellid = models.PositiveIntegerField() 
    analysis_Date = models.DateField()
...
class WigginsModel(models.Model):
    fgid = models.PositiveIntegerField()   
    wellid = models.PositiveIntegerField() 
    analysis_Date = models.DateField()
...
class MultirateModel(models.Model):
    fgid = models.PositiveIntegerField()   
    wellid = models.PositiveIntegerField() 
    analysis_Date = models.DateField()
