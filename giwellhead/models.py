...
class GIWellhead(models.Model):  
    gifgid = models.PositiveIntegerField()   
    giwellid = models.PositiveIntegerField() 
    giwh_Make = models.CharField(max_length=50)
    giwh_Model = models.CharField(max_length=50)
    WHTypes= (
    ("Single" , 'Single'),
    ("Dual" , 'Dual'),
    )
    giwh_Type =models.CharField(max_length = 50,choices = WHTypes,default = 'Single')   
    SealingTypes = (
        ("Elastomer" , 'Elastomer'),
    ...
    giseal =models.CharField(max_length = 50,choices = SealingTypes,default = 'MetaltoMetal') 
    HangerTypes = (
        ("Mandrel" , 'Mandrel'),
    ...
    gihanger_Type =models.CharField(max_length = 50,choices = HangerTypes,default = 'Mandrel')     
    FlangeSizes = (
    ...
    giflange_Size=models.CharField(max_length = 50,choices = FlangeSizes, default = 'E1') 
    Connections=(
        ('Threaded','Threaded'),
        ('Welded','Welded'),
        ('Flanged', 'Flanged'),
    ...
    giconnection = models.CharField(max_length = 50,choices = Connections, default = 'Threaded') 
    ValveeSizes = (
        ('A', "2 1/16"),
        ('B', "3 1/16"),
        ('C', "3 1/8"),
    ...
    givalve_Size=models.CharField(max_length = 50,choices = ValveeSizes,default = 'A') 
    TempRatings = (
        ('K', "-75-180 F"), 
        ('L', "-50-180 F"), 
        ('N', "-50-140 F"),
    ...
    gitemperature_Rating=models.CharField(max_length = 50,choices = TempRatings,default = 'K')     
    Materials = (
    ...
    gimaterial=models.CharField(max_length = 50,choices = Materials,default = 'AA')     
    Services =(
        ('AA', "General Service"),
        ('BB', "General Service"), 
        ('CC', "General Service"), 
    ...
    giservice=models.CharField(max_length = 50,choices = Services,default = 'AA') 
    ...
    giproduct_Service_Level=models.CharField(max_length = 50,choices = ServiceLevels,default = 'PL1') 


class GITree(models.Model):  
    giwellhead = models.ForeignKey(GIWellhead, on_delete=models.CASCADE)
    gifgid = models.PositiveIntegerField()   
    giwellid = models.PositiveIntegerField() 
    gimake = models.CharField(max_length=50)
    gimodel = models.CharField(max_length=50)
    TreeTypes= (
    ...
    gitreetype =models.CharField(max_length = 50,choices = TreeTypes,default = 'Single')  
    PressureRatings = (
        ("K2" , '2000 psi'),
        ("K3" , '3000 psi'),
        ("K5" , '5000 psi'),
    ...
    gipressure_rating =models.CharField(max_length = 50,choices = PressureRatings,default = 'K5')     
    ValveeSizes = (
        ('A', "2 1/16"),
        ('B', "3 1/16"),
        ('C', "3 1/8"),
    ...
    gimaterialRating=models.CharField(max_length = 50,choices = Materials,default = 'AA')     
    Services =(
        ('AA', "General Service"),
        ('BB', "General Service"), 
        ('CC', "General Service"), 
    ...
    giproduvt_service_level=models.CharField(max_length = 50,choices = ServiceLevels,default = 'PL1') 
