...
class GPWellhead(models.Model):  
    gpfgid = models.PositiveIntegerField()   
    gpwellid = models.PositiveIntegerField() 
    gpwh_Make = models.CharField(max_length=50)
    gpwh_Model = models.CharField(max_length=50)
    WHTypes= (
    ("Single" , 'Single'),
    ("Dual" , 'Dual'),
    )
    gpwh_Type =models.CharField(max_length = 50,choices = WHTypes,default = 'Single')   
    SealingTypes = (
        ("Elastomer" , 'Elastomer'),
    ...
    gpseal =models.CharField(max_length = 50,choices = SealingTypes,default = 'MetaltoMetal') 
    HangerTypes = (
        ("Mandrel" , 'Mandrel'),
    ...
    gphanger_Type =models.CharField(max_length = 50,choices = HangerTypes,default = 'Mandrel')     
    FlangeSizes = (
    ...
    gpflange_Size=models.CharField(max_length = 50,choices = FlangeSizes, default = 'E1') 
    Connections=(
        ('Threaded','Threaded'),
        ('Welded','Welded'),
        ('Flanged', 'Flanged'),
    ...
    gpconnection = models.CharField(max_length = 50,choices = Connections, default = 'Threaded') 
    ValveeSizes = (
        ('A', "2 1/16"),
        ('B', "3 1/16"),
        ('C', "3 1/8"),
    ...
    gpvalve_Size=models.CharField(max_length = 50,choices = ValveeSizes,default = 'A') 
    TempRatings = (
        ('K', "-75-180 F"), 
        ('L', "-50-180 F"), 
        ('N', "-50-140 F"),
    ...
    gptemperature_Rating=models.CharField(max_length = 50,choices = TempRatings,default = 'K')     
    Materials = (
    ...
    gpmaterial=models.CharField(max_length = 50,choices = Materials,default = 'AA')     
    Services =(
        ('AA', "General Service"),
        ('BB', "General Service"), 
        ('CC', "General Service"), 
    ...
    gpservice=models.CharField(max_length = 50,choices = Services,default = 'AA') 
    ...
    gpproduct_Service_Level=models.CharField(max_length = 50,choices = ServiceLevels,default = 'PL1') 


class GPTree(models.Model):  
    gpwellhead = models.ForeignKey(GPWellhead, on_delete=models.CASCADE)
    gpfgid = models.PositiveIntegerField()   
    gpwellid = models.PositiveIntegerField() 
    gpmake = models.CharField(max_length=50)
    gpmodel = models.CharField(max_length=50)
    TreeTypes= (
    ...
    gptreetype =models.CharField(max_length = 50,choices = TreeTypes,default = 'Single')  
    PressureRatings = (
        ("K2" , '2000 psi'),
        ("K3" , '3000 psi'),
        ("K5" , '5000 psi'),
    ...
    gppressure_rating =models.CharField(max_length = 50,choices = PressureRatings,default = 'K5')     
    ValveeSizes = (
        ('A', "2 1/16"),
        ('B', "3 1/16"),
        ('C', "3 1/8"),
    ...
    gpmaterialRating=models.CharField(max_length = 50,choices = Materials,default = 'AA')     
    Services =(
        ('AA', "General Service"),
        ('BB', "General Service"), 
        ('CC', "General Service"), 
    ...
    gpproduvt_service_level=models.CharField(max_length = 50,choices = ServiceLevels,default = 'PL1') 
