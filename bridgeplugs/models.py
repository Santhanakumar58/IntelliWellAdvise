...
class BridgePlug(models.Model):    
    ...
    setting_range_ppf = models.TextField(max_length=25, blank=True, null=True)
    Setting_Mechanisms = (
        ("Mechanical", "Mechanical"),
        ("Wireline", "Wireline"),
        )
    setting_mechanism = models.CharField(max_length = 20,choices = Setting_Mechanisms,default = '1', blank=True, null=True)
    plug_Make = models.TextField(max_length=50, blank=True, null=True)   
    plug_Model =  models.TextField(max_length=50, blank=True, null=True)    
