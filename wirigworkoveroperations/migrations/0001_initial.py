...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('wirigworkover', '0001_initial'),
    ]

    operations = [
        migrations.CreateModel(
            name='WIRigworkoverOperation',
            fields=[
                ...
                ('wirigworkover', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='wirigworkover.wirigworkover')),
            ],
        ),
    ]
