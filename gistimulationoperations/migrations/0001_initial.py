...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('gistimulation', '0001_initial'),
    ]

    operations = [
        migrations.CreateModel(
            name='GIStimulationOperation',
            fields=[
                ...
                ('gistimulation', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='gistimulation.gistimulation')),
            ],
        ),
    ]
