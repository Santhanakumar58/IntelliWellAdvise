...
import constantpressuredrawdowntestanalysis.models
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='ConstantPressureDrawdowntest',
            fields=[
                ...
                ('file_Name', models.FileField(blank=True, null=True, upload_to=constantpressuredrawdowntestanalysis.models.filepath)),
            ],
        ),
    ]
