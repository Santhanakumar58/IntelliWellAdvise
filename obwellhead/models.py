...
class OBWellhead(models.Model):  
    ...
    obwh_Type =models.CharField(max_length = 50,choices = WHTypes,default = 'Single')   
    SealingTypes = (
        ("Elastomer" , 'Elastomer'),
    ...
    obseal =models.CharField(max_length = 50,choices = SealingTypes,default = 'MetaltoMetal') 
    HangerTypes = (
        ("Mandrel" , 'Mandrel'),
    ...
    obhanger_Type =models.CharField(max_length = 50,choices = HangerTypes,default = 'Mandrel')     
    FlangeSizes = (
    ...
    obflange_Size=models.CharField(max_length = 50,choices = FlangeSizes, default = 'E1') 
    Connections=(
        ('Threaded','Threaded'),
        ('Welded','Welded'),
        ('Flanged', 'Flanged'),
    ...
    obconnection = models.CharField(max_length = 50,choices = Connections, default = 'Threaded') 
    ValveeSizes = (
        ('A', "2 1/16"),
        ('B', "3 1/16"),
        ('C', "3 1/8"),
    ...
    obvalve_Size=models.CharField(max_length = 50,choices = ValveeSizes,default = 'A') 
    TempRatings = (
        ('K', "-75-180 F"), 
        ('L', "-50-180 F"), 
        ('N', "-50-140 F"),
    ...
    obtemperature_Rating=models.CharField(max_length = 50,choices = TempRatings,default = 'K')     
    Materials = (
    ...
    obmaterial=models.CharField(max_length = 50,choices = Materials,default = 'AA')     
    Services =(
        ('AA', "General Service"),
        ('BB', "General Service"), 
        ('CC', "General Service"), 
    ...
    observice=models.CharField(max_length = 50,choices = Services,default = 'AA') 
    ...
    obproduct_Service_Level=models.CharField(max_length = 50,choices = ServiceLevels,default = 'PL1') 


class OBTree(models.Model):  
    obwellhead = models.ForeignKey(OBWellhead, on_delete=models.CASCADE)
    obfgid = models.PositiveIntegerField()   
    obwellid = models.PositiveIntegerField() 
    ...
    obtreetype =models.CharField(max_length = 50,choices = TreeTypes,default = 'Single')  
    PressureRatings = (
        ("K2" , '2000 psi'),
        ("K3" , '3000 psi'),
        ("K5" , '5000 psi'),
    ...
    obpressure_rating =models.CharField(max_length = 50,choices = PressureRatings,default = 'K5')     
    ValveeSizes = (
        ('A', "2 1/16"),
        ('B', "3 1/16"),
        ('C', "3 1/8"),
    ...
    obmaterialRating=models.CharField(max_length = 50,choices = Materials,default = 'AA')     
    Services =(
        ('AA', "General Service"),
        ('BB', "General Service"), 
        ('CC', "General Service"), 
    ...
    obproduvt_service_level=models.CharField(max_length = 50,choices = ServiceLevels,default = 'PL1') 
